      ...
      {!isConnected && (
        <section className="section-connect">
          <div className="connect-card">
            <div className="hero-logo">L</div>
            <h1 className="hero-title">LuvvyLoL</h1>
        ...
        <div className="toolbar">
          ...
          <div className="toolbar-toggles">
            ...
            <button className="btn btn-sm" onClick={() => {
              invoke("test_overlay").catch((error) => alert(`Overlay test failed: ${error}`));
            }}>Test Overlay</button>
          </div>
        </div>
      )}
...
function queueLabel(queueId: number, gameMode: string): string {
  ...
  if (queueId === 490) return "Swiftplay";
...
function OverlayApp() {
  ...
  if (!state || !state.live_game) return (
    <div className="overlay">
      <div className="ov-cspm">
        <span className="ov-cspm-value">0.0</span>
  ...
  return (
    <div className="overlay">
      ...
      <div className="ov-cspm">
        <span className="ov-cspm-value">{csPerMinute.toFixed(1)}</span>
        <span className="ov-cspm-label">CS / MIN</span>
